...
| 25 | CAP TABLE | 투자 전 45/45/ESOP 10 → 투자 후 40.5/40.5/9 + 투자자 10 |
...
캡테이블은 창업 2인 동일 지분(45% / 45% · ESOP 10%) 구조로 정리되었습니다. 설립 시점 기준이며 세부 수치는 변동될 수 있고, 대표이사 캐스팅보트 등 의사결정 구조는 주주간계약(SHA)으로, 공동창업자 지분은 4년 베스팅 · 1년 클리프로 정합니다.
