...
- 샘플 벡터: [frame-002.svg](/selly-strategy-table/assets/figma/dambbukharu/brand-guide/frame-002.svg)

## 사용 방법

1. Figma에서 File > Import를 선택합니다.
2. `assets/figma/dambbukharu/brand-guide/` 폴더의 `*.svg` 파일을 드래그해 가져옵니다.
